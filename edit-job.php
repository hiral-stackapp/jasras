...
if (!empty($action) && $action == 'edit') {
    ...
    $job_start_time = ( isset($_POST['job_start_time']) ) ? date("H:i:s", strtotime($_POST['job_start_time'])) : '';
    $job_end_time = ( isset($_POST['job_end_time']) ) ? date("H:i:s", strtotime($_POST['job_end_time'])) : '';
}
...
if (isset($_POST['submit'])) {
    ...
    $new_job_id = $database->update("jobs_meta", [
    ...
    <div class="row">
        ...
        if (empty($job_id)) {
            ...
            <div class="alert alert-danger">
                <h3>Please Select a Job to Edit.</h3>
                <p>Click <a href="/view-jobs.php">here to continue</a>...</p>
            </div>
                ...
                <div class="row">
                    <div class="form-group clearfix">
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="job_id" name="job_id" value="<?php echo $printdata[0]['job_id']; ?>" class="form-control"  readonly>
                        </div>

                        <div class="col-lg-6">
                            <label for="client_id" class="">Client Name</label>
                            <input type="text" id="client_name" name="client_name" value="<?php echo $printdata[0]['client_name']; ?>" class="form-control" readonly>
                            <input type="hidden" id="client_id" name="client_id" value="<?php echo $printdata[0]['client_id']; ?>" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group clearfix">
                        <div class="col-lg-2">
                            ...
                            <input type="text" id="job_date" name="job_date" class="form-control job_date" placeholder="0" tabindex="<?= $idx++; ?>" value="<?= (isset($printdata[0]['job_date'])) ? date('d/m/Y', strtotime($printdata[0]['job_date'])) : date('d/m/Y'); ?>" required data-position='bottom left'>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group clearfix">
                            ...
                            <input type="hidden" name="id" value="<?php echo $jobsub_id; ?>">
                            <input type="hidden" name="job_start_time" value="">
                            <input type="hidden" name="job_end_time" value="">
                        </div>
                    </div>
                </div>
